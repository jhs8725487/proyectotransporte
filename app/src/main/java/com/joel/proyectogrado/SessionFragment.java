...
public class SessionFragment extends Fragment implements Response.Listener<JSONObject>, Response.ErrorListener{
    ...
    public void iniciarSession(String selectedUser){
        String url="http://192.168.0.17//ejemploBDRemota/sesion.php?usu_usuario="+mTextInputEmail.getText().toString()+"&usu_password="+mTextInputPassword.getText().toString()+"&Rol="+selectedUser;
